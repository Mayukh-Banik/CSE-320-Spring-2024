...
Test(penis, penis)
{
    char *cmd = "bin/huff -c < rsrc/gettysburg.txt > ibtw.txt";
    system(cmd);
    char *cmd1 = "bin/huff -d < ibtw.txt > ii.txt";
    system(cmd1);
    char *cmd2 = "cmp rsrc/gettysburg.txt ii.txt";
    system(cmd2);
}
...
// Test(basecode_tests_suite, validargs_h_flag_test) {
//     int argc = 2;
//     char *argv[] = {"bin/huff", "-h", NULL};
//     int ret = validargs(argc, argv);
//     int exp_ret = 0;
...
// Test(basecode_tests_suite, validargs_c_flag_blocksize_test) {
//     int argc = 4;
//     char *argv[] = {"bin/huff", "-c", "-b", "1024", NULL};
//     int ret = validargs(argc, argv);
//     int exp_ret = 0;
...
// Test(basecode_tests_suite, validargs_d_flag_test) {
//     int argc = 2;
...
// Test(basecode_tests_suite, invalidargs_c_d_flags_blocksize_test) {
//     int argc = 5;
//     char *argv[] = {"bin/huff", "-c", "-d", "-b", "1024", NULL};
//     int ret = validargs(argc, argv);
//     int exp_ret = -1;
//     cr_assert_eq(ret, exp_ret, "Invalid return for invalid args. Got: %d | Expected: %d",
// 		 ret, exp_ret);
// }

// Test(basecode_tests_suite, invalidargs_blocksize_c_flags_test) {
//     int argc = 4;
//     char *argv[] = {"bin/huff", "-b", "1024", "-c", NULL};
//     int ret = validargs(argc, argv);
//     int exp_ret = -1;
//     cr_assert_eq(ret, exp_ret, "Invalid return for invalid args. Got: %d | Expected: %d",
// 		 ret, exp_ret);
...
// Test(basecode_tests_suite, invalidargs_d_flag_blocksize_test) {
//     int argc = 4;
//     char *argv[] = {"bin/huff", "-d", "-b", "1024", NULL};
//     int ret = validargs(argc, argv);
//     int exp_ret = -1;
...
// Test(basecode_tests_suite, invalidargs_c_flag_blocksize_1k_test) {
//     int argc = 4;
